...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 8. Wait until the element with the student name is displayed.
    await waitForElement(() => getByText(appointment, "Lydia Miller-Jones"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    // mock axios.put to return a rejected promise
    ...
    // 6. Check that the element with the text "could not save appointment" is displayed.
    await waitForElement(() =>
      getByText(appointment, /could not save appointment/i)
    );
    // 7. Click the "Close" button on the error.
